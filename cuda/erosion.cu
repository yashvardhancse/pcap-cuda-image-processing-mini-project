...
extern "C" CUDA_IMAGE_API int erosion_cpu(const unsigned char* input_rgba, unsigned char* output_rgba, int width, int height, float strength) {
    return run_morphology_cpu_impl(input_rgba, output_rgba, width, height, strength);
}

extern "C" CUDA_IMAGE_API int erosion_cuda_naive(const unsigned char* input_rgba, unsigned char* output_rgba, int width, int height, float strength) {
    return run_morphology_cuda_naive_impl(input_rgba, output_rgba, width, height, strength);
}

extern "C" CUDA_IMAGE_API int erosion_cuda_optimized(const unsigned char* input_rgba, unsigned char* output_rgba, int width, int height, float strength) {
